...
const statusStyles: { success: string; processing: string; failed: string } = {
...
export default class Cliente extends Component<{}, ClienteState> {
  constructor(props) {
    super(props);
    this.state = {
      sidebarOpen: false,
      ...
      <>
        <div className="min-h-full">
          <Transition.Root show={this.state.sidebarOpen} as={Fragment}>
            <Dialog as="div" className="relative z-40 lg:hidden" onClose={() => this.setState({ sidebarOpen: false })}>
              <Transition.Child
                as={Fragment}
